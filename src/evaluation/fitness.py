...
class MultiObjectiveFitness:
    def __init__(self, w_accuracy: float = 1.0, w_stability: float = 0.1,
                 w_runtime: float = 0.05, reference_time: float = 100.0):
    ...
    def calculate_fitness(self, training_history: Dict[str, Any]) -> float:
        metrics = MetricsCalculator.get_all_metrics(training_history, self.reference_time)
    ...
    def calculate_with_metrics(self, training_history: Dict[str, Any]) -> Dict[str, Any]:
