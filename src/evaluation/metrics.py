...
class MetricsCalculator:
    ...
    @staticmethod
    def calculate_runtime_penalty(
        history: Dict[str, Any], reference_time: float = 100.0
    ) -> float:
    ...
    def get_all_metrics(
        ...
        return {
            ...
            "runtime_penalty": MetricsCalculator.calculate_runtime_penalty(
                history, reference_time
            ),
